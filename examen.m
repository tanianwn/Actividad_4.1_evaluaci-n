...
for k = 1:N
    ...
    % Velocidad angular
    w(k) = (4*(cos(tk.^2) - 2*tk.^2 .* sin(tk.^2))) ./ (1 + 16*tk.^2 .* cos(tk.^2).^2);
...
axis([-3 30 -3 30 0 2]); % Ingresar limites minimos y maximos en los ejes x y z [minX maxX minY maxY minZ maxZ]
